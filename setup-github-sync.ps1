# Deep360 GitHub 自动同步设置
Write-Host "🚀 设置 GitHub 自动同步..." -ForegroundColor Green

$SERVER_IP = "74.208.61.148"
$GITHUB_REPO = "zyikun0911/deep360"
$WEBHOOK_SECRET = "deep360-secret-$(Get-Random -Minimum 1000 -Maximum 9999)"
...
Write-Host ""
Write-Host "✅ GitHub 同步配置创建完成！" -ForegroundColor Green
Write-Host ""
Write-Host "📋 配置信息:" -ForegroundColor Yellow
